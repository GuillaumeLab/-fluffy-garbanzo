...
annonces = pd.read_csv('C:/Users/Administrateur/Documents/SIMPLONr/df_new_pymongo_no_duplicate.csv',encoding='utf-8')
...
scientist = ["scientist","scientifique","math","statisticien"]
...
annonces["Details"]=annonces["Details"].str.replace(" thèse","bac+8").str.replace("doctorat","bac+8").str.replace("doctorant","bac+8").str.replace("phd","bac+8")
...
def langages_pro(df):
    ...
    regex = r'(?: r |python|sql|nosql|mysql|matlab|c\+|scala|ruby|php|vba|machine learning|ml|javascript|java |hadoop|spark|mongodb\
              ...
              hbase|mongodb|cassandra|hbase|rstudio|elasticsearch|neo4j|kibana|d3|Zeppelin|graffana|rshiny|shiny|jupyter|qlik|spotfire|dataiku|stackoverflow|jira|bitbucket|confluence|bamboo|github|gitlab|jenkins|nsible|scrum|kanban)'
...
#annonces["Niveau d'études"].loc[annonces["Niveau d'études"]=="nan"]=5
